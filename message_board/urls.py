...
from message_board.views import (AdListAPIView, AdRetrieveAPIView, AdCreateAPIView, AdDestroyAPIView, AdUpdateAPIView,
...
urlpatterns = [
    ...
    path("ad/<int:pk>/comments/", AdCommentListAPIView.as_view(), name="ad_comment_list"),
